...
public class Messages {
    ...
    public static final Message ALLTHREECOMPLETED = new Message("all-three-completed", "&6You have completed all three missions today! You have received &b&l%reward% &6as an additional reward!");
